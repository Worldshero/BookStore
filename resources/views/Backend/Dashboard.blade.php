                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-12">
                          <div class="d-flex no-block align-items-center">
                            <div>
                               <div class="icon"><i class="lni-bar-chart"></i></div>
                        ...
                        <div class="col-12">
                          <div class="d-flex no-block align-items-center">
                            <div>
                               ...
                               <p class="text-muted">Total Delivered Book</p>
                            </div>
                            <div class="ml-auto">
                        ...
                        <ul class="list-media">
                          <li class="list-item">
                            <div class="client-item">
                              <div class="media-img">
                                <img src="assets2/img/avatar/user1.png" alt="">
                              </div>
                              <div class="info">
                          ...
                          <li class="list-item">
                            <div class="client-item">
                              <div class="media-img">
                                <img src="assets2/img/avatar/user2.png" alt="">
                              </div>
                              <div class="info">
                          ...
                          <li class="list-item">
                            <div class="client-item">
                              <div class="media-img">
                                <img src="assets2/img/avatar/user3.png" alt="">
                              </div>
                              <div class="info">
                          ...
                          <li class="list-item">
                            <div class="client-item">
                              <div class="media-img">
                                <img src="assets2/img/avatar/user4.png" alt="">
                              </div>
                              <div class="info">
                        ...
                        <ul class="event-item">
                          <li>
                            <a href="">
                              <div class="media">
                                <div class="img-thumb">
                                  <img class="img-fluid" src="assets2/img/event/img-1.jpg" alt="">
                                </div>
                                <div class="text">
                          ...
                          <li>
                            <a href="">
                              <div class="media">
                                <div class="img-thumb">
                                  <img class="img-fluid" src="assets2/img/event/img-2.jpg" alt="">
                                </div>
                                <div class="text">
