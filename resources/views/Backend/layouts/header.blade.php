...
<div class="header navbar">
    <div class="header-container">
      <div class="nav-logo">
        <a href="index.html">
          <b><img src="assets2/img/logo.png" alt=""></b>
          <span class="logo">
            <img src="assets2/img/quickfind.png" alt="">
          </span>
        </a>
      </div>
      <ul class="nav-left">
      ...
      <ul class="nav-right">
              ...
              <ul class="list-media">
                <li class="list-item">
                  <a href="#" class="media-hover">
                    <div class="media-img">
                      <img src="assets2/img/users/avatar-1.jpg" alt="">
                    </div>
                    <div class="info">
                      <span class="title">
                          Amanda Robertson
                ...
                <li class="list-item">
                  <a href="#" class="media-hover">
                    <div class="media-img">
                      <img src="assets2/img/users/avatar-2.jpg" alt="">
                    </div>
                    <div class="info">
                      <span class="title">
                        Danny Donovan
                ...
                <li class="list-item">
                  <a href="#" class="media-hover">
                    <div class="media-img">
                      <img src="assets2/img/users/avatar-3.jpg" alt="">
                    </div>
                    <div class="info">
                      <span class="title">
                        Frank Handrics
        ...
        <li class="user-profile dropdown dropdown-animated scale-left">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img class="profile-img img-fluid" src="assets2/img/avatar/avatar.jpg" alt="">
          </a>
            ...
            <li>
              <ul class="list-media">
                <li class="list-item avatar-info">
                  <div class="media-img">
                    <img src="assets2/img/avatar/avatar.jpg" alt="">
                  </div>
                  <div class="info">
      ...
      <ul class="side-nav-menu">
        ...
        <li class="nav-item dropdown">
          <a class="dropdown-toggle" href="#">
            ...
            <span class="title">Book Category</span>
            <span class="arrow">
          ...
          <ul class="dropdown-menu sub-down">
            <li>
              <a href="line-icons.html">Add New Category</a>
            </li>
            <li>
              <a href="fontawesome-icons.html">List All Category</a>
            </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu sub-down">
            <li>
              <a href="line-icons.html">Add New Book</a>
            </li>
            <li>
              <a href="fontawesome-icons.html">List All Book</a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu sub-down">
            <li>
              <a href="google-map.html">Premium Customer</a>
            </li>
            <li>
              <a href="vector-map.html">Registered Customer</a>
            </li>
          </ul>
        </li>
        <li class="nav-item dropdown">
